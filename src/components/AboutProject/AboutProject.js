    ...
    <section className="about-project" id="about-project">
      ...
      <div className="about-project__description-block">
        <div>
          ...
          <p className="about-project__description-text">Составление плана, работу над бэкендом,
        ...
        <div>
          ...
          <p className="about-project__description-text">У каждого этапа был мягкий и жёсткий
      ...
      <div className="about-project__duration">
        <div className="about-project__duration-element">
          <div className="about-project__weeks about-project__weeks_backend">1 неделя</div>
          <p className="about-project__second-title">Back-end</p>
        </div>
        <div className="about-project__duration-element about-project__duration-element_frontend">
          <div className="about-project__weeks about-project__weeks_frontend">4 недели</div>
